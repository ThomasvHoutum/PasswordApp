...
public class SearchManagerTest
{
    ...
    public void Search_ShouldReturnMatchingEntries_WhenQueryIsFound()
    {
        ...
        {
            new("Google", "John Doe", "john@example.com", "password123", new List<SecurityQuestion>()),
            new("Facebook", "Jane Smith", "jane@example.com", "password456", new List<SecurityQuestion>()),
            new("Twitter", "Alice Johnson", "alice@example.com", "password789", new List<SecurityQuestion>())
        };
    ...
    public void Search_ShouldReturnEmptyList_WhenQueryIsNotFound()
    {
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Empty(result); // No entries should match
    }
}